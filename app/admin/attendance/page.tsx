    ...
    <div className="bg-[#f6f6f8] text-slate-900 min-h-screen font-['Manrope',_sans-serif]">
      <div className="layout-container flex h-full flex-col">
        ...
        <header className="flex items-center justify-between whitespace-nowrap border-b border-slate-200 bg-white px-10 py-3">
          <div className="flex items-center gap-8">
            <div className="flex items-center gap-4 text-[#2b6cee]">
              <div className="size-8 bg-[#2b6cee]/10 rounded-lg flex items-center justify-center">
                <span className="material-symbols-outlined text-[#2b6cee]">rocket_launch</span>
              </div>
              <h2 className="text-slate-900 text-lg font-bold leading-tight tracking-tight">PayrollHR</h2>
            </div>
            <nav className="flex items-center gap-6">
              <Link className="text-slate-600 text-sm font-medium hover:text-[#2b6cee] transition-colors" href="/admin">Dashboard</Link>
              <Link className="text-slate-600 text-sm font-medium hover:text-[#2b6cee] transition-colors" href="/admin/employees">Employees</Link>
              <Link className="text-slate-600 text-sm font-medium hover:text-[#2b6cee] transition-colors" href="/admin/payroll">Payroll</Link>
          ...
          <div className="flex flex-1 justify-end gap-4 items-center">
            <label className="relative flex min-w-40 max-w-64">
              ...
              <input className="w-full rounded-lg border-none bg-slate-100 py-2 pl-10 pr-4 text-sm focus:ring-2 focus:ring-[#2b6cee]/20 placeholder:text-slate-400" placeholder="Search employees..." />
            </label>
            ...
            <div className="rounded-full size-10 overflow-hidden border-2 border-slate-100">
        ...
        <main className="max-w-[1200px] mx-auto w-full px-6 py-8">
          {/* Title */}
          <div className="mb-8">
            <h1 className="text-slate-900 text-3xl font-extrabold tracking-tight mb-2">Attendance Tracking</h1>
            <p className="text-slate-500">Monitor employee check-ins, leave requests, and overtime in one place.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div className="bg-white rounded-xl p-6 shadow-sm border border-slate-200">
              <div className="flex items-center justify-between mb-2">
                <span className="text-slate-500 text-sm font-medium">Total Present Today</span>
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm border border-slate-200">
              <div className="flex items-center justify-between mb-2">
                <span className="text-slate-500 text-sm font-medium">Pending Leaves</span>
              ...
              <div className="flex items-end gap-3">
                ...
                <span className="text-slate-400 text-sm font-semibold mb-1">vs yesterday</span>
              </div>
            </div>
            <div className="bg-white rounded-xl p-6 shadow-sm border border-slate-200">
              <div className="flex items-center justify-between mb-2">
              ...
              <div className="flex items-end gap-3">
                <span className="text-3xl font-bold text-slate-900">42 hrs</span>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
            <div className="flex flex-col sm:flex-row sm:items-center justify-between px-6 pt-4 border-b border-slate-100">
              <div className="flex gap-8 overflow-x-auto">
                ...
                <a className="border-b-2 border-transparent hover:border-slate-300 pb-4 px-1 transition-all" href="#">
                  <span className="text-sm font-bold text-slate-500">Leave Requests</span>
                </a>
                <a className="border-b-2 border-transparent hover:border-slate-300 pb-4 px-1 transition-all" href="#">
                  <span className="text-sm font-bold text-slate-500">Overtime</span>
                </a>
              </div>
              <div className="flex items-center gap-3 pb-4 pt-2 sm:pt-0">
                <button className="flex items-center gap-2 rounded-lg bg-slate-100 px-3 py-2 text-sm font-semibold text-slate-700 hover:bg-slate-200 transition-colors">
              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="bg-slate-50/50">
                    ...
                    <th className="px-6 py-4 text-xs font-bold uppercase tracking-wider text-slate-500">Time In</th>
                    <th className="px-6 py-4 text-xs font-bold uppercase tracking-wider text-slate-500">Time Out</th>
                    <th className="px-6 py-4 text-xs font-bold uppercase tracking-wider text-slate-500 text-center">Total Hours</th>
                ...
                <tbody className="divide-y divide-slate-100">
                  {[
                    ...
                    <tr key={emp.name} className="hover:bg-slate-50 transition-colors">
                      <td className="px-6 py-4 text-sm text-slate-600 font-medium">Oct 24, 2023</td>
                      ...
                      <td className="px-6 py-4 text-sm text-slate-700">{emp.timeIn}</td>
                      <td className="px-6 py-4 text-sm text-slate-700">{emp.timeOut}</td>
            ...
            <div className="px-6 py-4 border-t border-slate-100 flex items-center justify-between">
              <p className="text-xs text-slate-500 font-medium uppercase tracking-wider">Showing 1 to 5 of 124 employees</p>
              <div className="flex gap-2">
                <button className="size-8 flex items-center justify-center rounded border border-slate-200 bg-white text-slate-600 hover:bg-slate-50">
                ...
                <button className="size-8 flex items-center justify-center rounded border border-slate-200 bg-white text-slate-600 hover:bg-slate-50 text-xs font-bold">2</button>
                <button className="size-8 flex items-center justify-center rounded border border-slate-200 bg-white text-slate-600 hover:bg-slate-50 text-xs font-bold">3</button>
                <button className="size-8 flex items-center justify-center rounded border border-slate-200 bg-white text-slate-600 hover:bg-slate-50">
