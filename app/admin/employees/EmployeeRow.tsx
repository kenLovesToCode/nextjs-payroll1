  ...
  return (
    <tr className="hover:bg-[#2b6cee]/[0.02] transition-colors group">
      ...
      <td className="px-6 py-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <div className="text-[11px] font-medium text-slate-500">{employee.email}</div>
          </div>
        </div>
      </td>
      {/* Department */}
      <td className="px-6 py-4 text-sm font-bold text-slate-600">{employee.department}</td>
      {/* Role */}
      ...
      <td className="px-6 py-4 text-right">
        <button className="p-2 text-slate-400 hover:text-[#2b6cee] hover:bg-[#2b6cee]/5 rounded-lg transition-all">
